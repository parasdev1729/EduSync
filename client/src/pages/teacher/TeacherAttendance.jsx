...
import { Loader2, Search, CheckCircle2, Send, ChevronDown } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      <div>
        ...
        <p className="text-slate-400 mt-2 font-medium">Select a student and request attendance modifications.</p>
      </div>
              ...
              <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-end">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    readOnly={!!updateForm.targetId}
                    className="w-full bg-black/20 border border-white/10 rounded-xl px-3 py-2 text-white focus:outline-none focus:ring-1 focus:ring-blue-500 read-only:opacity-50"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    min="1"
                    required
                    value={updateForm.totalClasses}
                    onChange={handleFormChange}
                    className="w-full bg-black/20 border border-white/10 rounded-xl px-3 py-2 text-white focus:outline-none focus:ring-1 focus:ring-blue-500"
                  />
                </div>
                <div className="space-y-2">
                ...
                <div className="sm:col-span-3 mt-4 flex justify-end">
                  <button 
                    ...
                    className="flex items-center px-6 py-2 rounded-xl font-bold text-white bg-blue-600 hover:bg-blue-500 transition-colors disabled:opacity-50"
                  >
